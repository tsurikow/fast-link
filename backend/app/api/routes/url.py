...
from backend.app.api.schemas.url import URLCreate, URLResponse, URLCustomCreate, URLUpdateRequest
...
from backend.app.services.url_helpers import update_url_background, get_optional_current_user
...
async def update_url(
    ...
    if update_data.original_url:
        new_original_url = update_data.original_url
